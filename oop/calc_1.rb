...
a = FancyCalculator.new.add(1,3)
p a
b = FancyCalculator.new.subtract(60,35)
p b
c = FancyCalculator.new.multiply(2,7)
p c
d = FancyCalculator.new.divide(9,3)
p d
e = FancyCalculator.new.square_root(16)
p e